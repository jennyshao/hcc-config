...
#
# Variables:
# $users_ldap_servers  (default: ["ldapm.red.com","ldaps.red.com"]) - Defines the ldap backend server(s) you want to use for ldap authentication
# $users_ldap_basedn (default: "dc=red,dc=com") - Defines the ldap base dn for ldap authentication
