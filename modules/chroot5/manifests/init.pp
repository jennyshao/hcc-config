...
class chroot5 (
 $chroot_top = $chroot5::params::chroot_top,
 $chroot_base = $chroot5::params::chroot_base,
 $chroot_root = $chroot5::params::chroot_root
) inherits chroot5::params {
...
## 
   ...
   file { "chroot_tool_cfg":
      ...
      content  => template("chroot5/tool.cfg.erb"),
   ...
   file { "chroot_tool_yum_conf":
      ...
      content  => template("chroot5/yum.conf.erb"),
      require  => Package["chroot-tool"],
   }
