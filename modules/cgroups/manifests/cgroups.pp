# Class foo::cgroups
#
# Custom project class for cgroups project. Use this to adapt the foo module to your project.
# This class is autoloaded if $my_module == cgroups
#
...
# class foo::cgroups inherits foo {
#     File["foo.conf"] {
